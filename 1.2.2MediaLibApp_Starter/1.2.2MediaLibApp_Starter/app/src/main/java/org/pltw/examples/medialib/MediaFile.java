...
public class MediaFile  
{
    ...
    public static String readString() {
        Log.d("MediaFile", "readString Called");
        if (in == null) {
            try {
                in = new Scanner(new File(Environment.getExternalStorageDirectory(), DATA_FILE));
            }
            catch (Exception e) {
    ...
    public static void writeString(String s) {
        if (out == null) {
            try {
                out = new BufferedWriter(new FileWriter(Environment.getExternalStorageDirectory() + "/" + DATA_FILE));
            }
            catch (Exception e) {
